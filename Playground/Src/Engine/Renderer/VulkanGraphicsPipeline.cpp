													...
													VkRenderPass renderPass, uint32_t subPass, uint32_t nOutputAttachments)
{
	...
	switch (m_eType)
	{
		...
		{
			m_strVertexShader = "Shaders/HDRISkydome.vert.spv";
			m_strFragmentShader = "Shaders/HDRISkydome.frag.spv";
		...
		case PipelineType::IRRADIANCE_CUBE:
		{
			m_strVertexShader = "Shaders/PreFilterCube.vert.spv";
			m_strFragmentShader = "Shaders/PreFilterCube.frag.spv";
		...
		case PipelineType::PREFILTER_SPEC:
		{
			m_strVertexShader = "Shaders/PreFilterSpec.vert.spv";
			m_strFragmentShader = "Shaders/PreFilterSpec.frag.spv";
		...
		case PipelineType::BRDF_LUT:
		{
			m_strVertexShader = "Shaders/BrdfLUT.vert.spv";
			m_strFragmentShader = "Shaders/BrdfLUT.frag.spv";
			...
			// Vertex Input (Don't need any input attribute in this case!)
			m_vkVertexInputStateCreateInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_STATE_CREATE_INFO;
