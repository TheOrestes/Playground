...
//---------------------------------------------------------------------------------------------------------------------
void VulkanFrameBuffer::CreateAttachment(VulkanDevice* pDevice, VulkanSwapChain* pSwapChain, AttachmentType eType)
{
	switch (eType)
	{
		...
		case AttachmentType::FB_ATTACHMENT_REFLECTION:
			break;
